...
class World():
    def __init__(self, data, tile_size, Traps, myTraps_group, Stalagmite, stalagmite_group, End_lvl, end_group):
        self.tile_list = []
        ...
        for row in data:
            ...
            for tile in row:
                ...
                if tile == 5:
                    exit = End_lvl(col_count * tile_size, row_count * tile_size - (tile_size // 2), tile_size)
                    end_group.add(exit)
